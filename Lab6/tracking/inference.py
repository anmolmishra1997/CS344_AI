...
class JointParticleFilter:
    ...
    def initializeParticles(self):
        ...
        # counter = 0
        # while counter < particles:
        #     positions.append(random.choice(allPositions))
        #     counter += 1
        #     if counter == particles:
        #         break
        ...
        for p in self.particles:
            ...
            for i in range(self.numGhosts):
                ...
                if emissionModels[i][trueDistance] > 0:
                    beliefs[p] = emissionModels[i][trueDistance] * beliefs[p]
                if emissionModels[i][trueDistance] == 0:
                    beliefs[p] = 0
            allPossible[p] = beliefs[p]
    ...
    def elapseTime(self, gameState):
        ...
        for oldParticle in self.particles:
            ...
            "*** YOUR CODE HERE ***"
            for i in range(self.numGhosts):
                newParticle.append(util.sample(getPositionDistributionForGhost( setGhostPositions(gameState, oldParticle), i, self.ghostAgents[i])))
